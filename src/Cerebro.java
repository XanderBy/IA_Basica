...
public class Cerebro {
	// Los pesos serán arreglos multidimensionales. Así: W[capa, neurona inicial,neurona final]
	private double[][][] W; 
	...
	double[][] A; 
	// Los nuevos pesos serán arreglos multidimensionales. Así: W[capa, neurona inicial, neurona final]
	private double[][][] WN; 
	// Los nuevos umbrales de cada neurona serán arreglos bidimensionales. Así: U[capa, neurona que produce la salida]
	private double[][] UN; 
	// El total de capas que tendrá el perceptrón incluyendo la capa de entrada
	private int TotalCapas; 
	// Cuantas neuronas habrá en cada capa
	private int[] neuronasporcapa; 
	// Total de entradas externas del perceptrón
	private int TotalEntradas; 
	// Total salidas externas del perceptrón
